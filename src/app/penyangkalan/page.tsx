      ...
      <div style={{ display: 'flex', minHeight: 'calc(100vh - 46px)' }}>
        ...
        <main style={{ flex: 1, minWidth: 0, backgroundColor: '#F8F9FA', padding: '2rem' }}>
          <div style={{ maxWidth: '800px' }}>
            ...
            {/* Warning banner */}
            <div style={{ backgroundColor: '#FEF2F2', border: '1px solid #FECACA', padding: '1rem 1.25rem', marginBottom: '1.5rem' }}>
              <p style={{ margin: 0, fontSize: '0.875rem', color: '#991B1B', fontWeight: 600, lineHeight: 1.6 }}>
                ⚠ VeriLex <strong>bukan</strong> firma hukum, pengacara, atau penasihat hukum resmi.
                Konten ini ditujukan semata-mata untuk kepentingan akademis, pendidikan, dan penelitian hukum.
              </p>
            </div>

            <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #A2A9B1', padding: '2rem', marginBottom: '1rem' }}>
              <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1.5rem', color: '#0F1B3C', borderBottom: '1px solid #A2A9B1', paddingBottom: '0.5rem', marginTop: 0, marginBottom: '1.5rem' }}>
                Penyangkalan (Disclaimer)
              </h1>

              <section style={{ marginBottom: '1.75rem' }}>
                <h2 style={{ fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: '1rem', color: '#202122', margin: '0 0 0.75rem', border: 'none', padding: 0 }}>
                  1. Bukan Nasihat Hukum
                </h2>
                <p style={{ fontSize: '0.9rem', lineHeight: 1.75, color: '#54595D' }}>
              ...
              <section style={{ marginBottom: '1.75rem' }}>
                ...
                <p style={{ fontSize: '0.9rem', lineHeight: 1.75, color: '#54595D' }}>
                  Penggunaan komersial tanpa izin tertulis dari tim VeriLex tidak diperkenankan.
                </p>
              </section>
              ...
              <section style={{ marginBottom: '1.75rem' }}>
                ...
                <p style={{ fontSize: '0.9rem', lineHeight: 1.75, color: '#54595D' }}>
                  ...
                  Ketersediaan tautan eksternal tidak berarti VeriLex mendukung atau menjamin keakuratan
              ...
              <section>
                <h2 style={{ fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: '1rem', color: '#202122', margin: '0 0 0.75rem', border: 'none', padding: 0 }}>
                  6. Perubahan pada Penyangkalan Ini
                </h2>
                <p style={{ fontSize: '0.9rem', lineHeight: 1.75, color: '#54595D', margin: 0 }}>
                  VeriLex berhak mengubah pernyataan penyangkalan ini sewaktu-waktu tanpa pemberitahuan terlebih
                  dahulu. Versi terbaru selalu tersedia di halaman ini. Penggunaan berkelanjutan platform VeriLex
                  setelah perubahan berlaku dianggap sebagai penerimaan atas penyangkalan yang diperbarui.
                </p>
              </section>
            </div>

            {/* Footer links */}
            <div style={{ backgroundColor: '#F8F9FA', border: '1px solid #A2A9B1', padding: '1rem 1.25rem', display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
              <span style={{ fontSize: '0.8125rem', color: '#72777D' }}>Lihat juga:</span>
              <Link href="/tentang" style={{ fontSize: '0.8125rem', color: '#0645AD' }}>Tentang VeriLex</Link>
              <Link href="/faq" style={{ fontSize: '0.8125rem', color: '#0645AD' }}>FAQ</Link>
              <Link href="/panduan" style={{ fontSize: '0.8125rem', color: '#0645AD' }}>Panduan Penggunaan</Link>
            </div>
